...
app.controller("PubCtrl", function ($scope) {
    $scope.pubList = [
          ...
          {
            "authors": "Cottingham, M., Phillips, D., Hall, S., Gearity, B., & Carroll, M.",
            "year": 2014,
            "desc": [
                "Application of the Motivation Scale for Disability Sport Consumption: An Examination of Intended Future Consumption Behavior of Collegiate Wheelchair Basketball Spectators. Journal of Sport Behavior, 37(2), 117-133.",
            ],
            "link": "https://pdfs.semanticscholar.org/a3ba/f749c9942052bf56241b2fb62394d885ba52.pdf"
          },
          {
